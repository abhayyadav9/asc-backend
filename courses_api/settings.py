...
SECRET_KEY = 'django-insecure-c5&blk#34stxv1bnh*-_0rov04zs+war$37!hh1db08_-w9g^l'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'courses_db'),
        'USER': os.environ.get('DB_USER', 'user'),
        'PASSWORD': os.environ.get('DB_PASSWORD', 'password'),
        'HOST': os.environ.get('DB_HOST', 'db'), # Updated for Docker
